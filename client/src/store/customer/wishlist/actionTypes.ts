const ActionTypes = {
  ...
  REMOVE_ITEM_TO_WISHLIST_REQUEST: "REMOVE_ITEM_TO_WISHLIST_REQUEST",
  REMOVE_ITEM_TO_WISHLIST_SUCCESS: "REMOVE_ITEM_TO_WISHLIST_SUCCESS",
  REMOVE_ITEM_TO_WISHLIST_FAILURE: "REMOVE_ITEM_TO_WISHLIST_FAILURE",
};
